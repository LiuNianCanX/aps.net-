<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bigmanager_FTChange.aspx.cs" Inherits="Manage_bigmanager_FTChange" %>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Charts &amp; graphs</a>
  <ul>
    <li class="active"> <a href="#"><i class="icon icon-signal"></i> <span>财务,教务管理</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 后台管理界面</a> <a href="#" class="current">财务,教务管理</a></div>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div id="placeholder">
                ...
                <br />
                <asp:Label ID="Label3" runat="server" Text="管理员类型 "></asp:Label>
                <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label4" runat="server" Text="管理员电话 "></asp:Label>
