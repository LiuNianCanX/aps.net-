<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacherPerson.aspx.cs" Inherits="Manage_teacherPerson" %>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Charts &amp; graphs</a>
  <ul>
    ...
    <li class="active"> <a href="#"><i class="icon icon-inbox"></i> <span>教务信息查询</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 教务管理</a> <a href="#" class="current">教务信息查询</a></div>
  </div>
          ...
          <div class="widget-content">
            <div id="placeholder">
                ...
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Size="Small" RepeatDirection="Horizontal">
                    <asp:ListItem Value="precise">精确</asp:ListItem>
                    <asp:ListItem Value="indistinct">模糊</asp:ListItem>
                </asp:RadioButtonList>
                <asp:Table ID="TableSearchResult" runat="server" GridLines="Both">
                    <asp:TableRow runat="server">
                        <asp:TableCell runat="server">学号</asp:TableCell>
                        <asp:TableCell runat="server">姓名</asp:TableCell>
                        <asp:TableCell runat="server">学院</asp:TableCell>
                        <asp:TableCell runat="server">专业</asp:TableCell>
                        <asp:TableCell runat="server">班级</asp:TableCell>
                        <asp:TableCell runat="server">性别</asp:TableCell>
                        <asp:TableCell runat="server">班主任</asp:TableCell>
                        <asp:TableCell runat="server">电话</asp:TableCell>
