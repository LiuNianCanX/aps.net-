<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentperson.aspx.cs" Inherits="StudentMS_StuMaMessage" %>
...
<body>
    ...
    <div id="sidebar" class="auto-style1">
        ...
        <ul>
            <li>&nbsp;</li>
            <li class="active"><a href="#"><i class="icon icon-signal"></i><span>学生个人信息</span></a> </li>
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"><a href="studentpaym.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>学费缴纳</a> <a href="#" class="current">个人中心</a></div>
        </div>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                                ...
                                <form id="form1" runat="server" class="form-horizontal">
                                    <div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="lbStudNo" runat="server" Enabled="False" class="span11" placeholder="studentNo"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">姓 名:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="lbStudName" runat="server" Enabled="False" class="span11" placeholder="First name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">班 级:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="lbStudClass" runat="server" Enabled="False" class="span11" placeholder="Class name"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">邮 箱:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="tbEmail" runat="server" Enabled="False" TextMode="Email"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">生 日:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="tbBirth" runat="server" Enabled="False" TextMode="Date"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">电 话:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="tbTel" runat="server" Enabled="False" TextMode="Phone"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">性 别:</label>
                                            <div class="controls">
                                                <asp:TextBox ID="tbSex" runat="server" Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <asp:Button ID="btnSet" class="btn btn-success" runat="server" Text="修改信息" OnClick="btnSet_Click" /><asp:Button ID="btnChangePw" class="btn btn-success" runat="server" Text="修改密码" OnClick="btnChangePw_Click" />
                            ...
                            <!--修改密码-->
                            <asp:Panel ID="PanelSetPw" runat="server">
                                <form id="form2" runat="server" class="form-horizontal">
                                    ...
                                    <div class="form-actions">
                                        <asp:Button ID="btnChangePwd" class="btn btn-success" runat="server" Text="确认修改" OnClick="BtnChangePwd_Click" />
