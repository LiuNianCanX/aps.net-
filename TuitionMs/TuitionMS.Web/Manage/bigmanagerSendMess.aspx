<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bigmanagerSendMess.aspx.cs" Inherits="Manage_bigmanagerSendMess" %>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Charts &amp; graphs</a>
  <ul>
    ...
    <li class="active"> <a href="#"><i class="icon icon-tint"></i> <span>公告发送</span></a></li>
    <li><a href="bigmanagerSeges.aspx"><i class="icon icon-inbox"></i> <span>建议管理</span></a> </li>
  </ul>
</div>
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 后台管理界面</a> <a href="#" class="current">公告发送</a></div>
  </div>
