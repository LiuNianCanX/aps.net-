<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacherseges_look.aspx.cs" Inherits="Manage_teacherseges_look" %>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 教务管理</a> <a href="#" class="current">查看来自学生的建议</a></div>
  </div>
