<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerseges_look.aspx.cs" Inherits="Manage_managerseges_look" %>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Charts &amp; graphs</a>
  <ul>
    ...
    <li class="active"><a href="#"><i class="icon icon-pencil"></i> <span>查看来自学生的建议</span></a></li>
  </ul>
</div>
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 财务管理</a> <a href="#" class="current">查看来自学生的建议</a></div>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div id="placeholder">
                ...
                <asp:GridView style="width:100%;" ID="gv" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True" OnPageIndexChanging="Gv_PageIndexChanging" AutoGenerateColumns="False">
           ...
           共<asp:Label ID="lblPageCount" runat="server" Text="<%# ((GridView)Container.Parent.Parent).PageCount %>"></asp:Label>页
                ...
                <asp:Button class="btn-warning" ID="btnFresh" runat="server" Text="刷新内容" OnClick="BtnFresh_Click"/>
                <asp:Button class="btn-warning" ID="btnDelChecked" runat="server" Text="删除所选项" OnClick="BtnDelChecked_Click" />
              </div>
          </div>
        </div>
      </div>
